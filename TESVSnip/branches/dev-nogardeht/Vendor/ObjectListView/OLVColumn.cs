...
namespace BrightIdeasSoftware
{
    ...
    /// </remarks>
    [Browsable(false), Serializable, Persistable(Flags = PersistType.Public | PersistType.Properties)]
    public class OLVColumn : ColumnHeader, ISerializable
    {
        /// <summary>
        /// Create an OLVColumn
        /// </summary>
        ...
        /// </summary>
        protected OLVColumn(SerializationInfo info, StreamingContext context)
        {
        ...
        public string GroupWithItemCountSingularFormatOrDefault
        {
            get
            {
                ...
                if (ListView != null)
                {
                    cachedGroupWithItemCountSingularFormat =
                        ((ObjectListView) ListView).GroupWithItemCountSingularFormatOrDefault;
        ...
        {
            get { return UseFiltering && ValuesChosenForFiltering != null && ValuesChosenForFiltering.Count > 0; }
        }
        ...
        public RenderDelegate RendererDelegate
        {
            get
            {
                if (Renderer is Version1Renderer)
                    return ((Version1Renderer) Renderer).RenderDelegate;
                else
                    return null;
            }
        ...
        {
            get { return textAlign.HasValue ? textAlign.Value : base.TextAlign; }
            set
            {
                textAlign = value;
        ...
        public IModelFilter ValueBasedFilter
        {
            get
            {
                ...
                return new OneOfFilter(ClusteringStrategy.GetClusterKey, ValuesChosenForFiltering);
            }
        ...
        /// <param name="subtitles"></param>
        /// <param name="tasks"></param>
        public void MakeEqualGroupies<T>(T[] values, string[] descriptions, object[] images, string[] subtitles,
                                         string[] tasks)
        {
            // Sanity checks
            if (values == null)
