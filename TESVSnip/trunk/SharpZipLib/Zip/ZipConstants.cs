...
namespace ICSharpCode.SharpZipLib.Zip
{
    ...
    internal static class ZipConstants
    {
        ...
        /// </remarks>
        [Obsolete("Use VersionMadeBy instead")] public const int VERSION_MADE_BY = 45;
        ...
        /// Signature for local entry header
        /// </summary>
        [Obsolete("Use LocalHeaderSignature instead")] public const int LOCSIG =
            'P' | ('K' << 8) | (3 << 16) | (4 << 24);
        ...
        /// Signature for spanning entry
        /// </summary>
        [Obsolete("Use SpanningSignature instead")] public const int SPANNINGSIG =
            'P' | ('K' << 8) | (7 << 16) | (8 << 24);
        ...
        /// so the values are recorded after the data prefixed by this header, as well as in the central directory.
        /// </remarks>
        [Obsolete("Use DataDescriptorSignature instead")] public const int EXTSIG =
            'P' | ('K' << 8) | (7 << 16) | (8 << 24);

        /// <summary>
        /// Signature for central header
        /// </summary>
        [Obsolete("Use CentralHeaderSignature instead")] public const int CENSIG =
            'P' | ('K' << 8) | (1 << 16) | (2 << 24);
...
#else
        private static readonly int defaultCodePage = Thread.CurrentThread.CurrentCulture.TextInfo.OEMCodePage;
#endif
