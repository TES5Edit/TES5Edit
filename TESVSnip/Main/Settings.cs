...
namespace TESVSnip
{
    internal static class Settings
    {
        ...
        public static void GetWindowPosition(string window, Form f)
        {
            ...
            {
                f.Location = new Point(int.Parse(xe.Attributes.GetNamedItem("left").Value),
                                       int.Parse(xe.Attributes.GetNamedItem("top").Value));
                f.ClientSize = new Size(int.Parse(xe.Attributes.GetNamedItem("width").Value),
                                        int.Parse(xe.Attributes.GetNamedItem("height").Value));
