...
namespace BrightIdeasSoftware
{
    ...
    public class OLVGroup
    {
        ...
        {
            if (ListView.SpaceBetweenGroups <= 0)
                return 0;
            ...
            metrics.Bottom = (uint) ListView.SpaceBetweenGroups;
            return NativeMethods.SetGroupMetrics(ListView, GroupId, metrics);
        }
