...
begin
  ...
  case MainRecord.FormID.ObjectID[aContainer.ContextObj.SlotLayout] of
...
//           TERM, HAIR, EYES, ADDN, RCPE, NULL]),
  ...
  wbConditionParameters := [
    ...
    {13} wbInteger('Crime Type', itU32, wbCrimeTypeEnum(Self)),
    {14} wbInteger('Critical Stage', itU32, wbCriticalStageEnum(Self)),
    {15} wbInteger('Equip Type', itU32, wbEquipTypeEnum),
    {16} wbInteger('Form Type', itU32, wbFormTypeEnum),
    {17} wbInteger('Menu Mode', itU32, wbMenuModeEnum(Self)),
    {18} wbInteger('Misc Stat', itU32, wbMiscStatEnum),
    {19} wbInteger('Player Action', itU32, wbPlayerActionEnum),
    {20} wbInteger('Sex', itU32, wbSexEnum(Self)),
  ...
  RegisterRecordDef(ARMO, 'Armor',
    ...
    wbBMDT,
    wbRStruct('Male', [
      wbTexturedModel(Self, 'Biped Model', [MODL, MODT], [wbMODS, wbMODD]),
      wbTexturedModel(Self, 'World Model', [MOD2, MO2T], [wbMO2S, nil]),
      wbString(ICON, 'Icon Image'),
      wbString(MICO, 'Message Icon')
    ]).IncludeFlag(dfAllowAnyMember)
      .IncludeFlag(dfStructFirstNotRequired),
    wbRStruct('Female', [
      wbTexturedModel(Self, 'Biped Model', [MOD3, MO3T], [wbMO3S, wbMOSD]),
      wbTexturedModel(Self, 'World Model', [MOD4, MO4T], [wbMO4S, nil]),
  ...
  RegisterRecordDef(CLAS, 'Class', [
    ...
    wbStruct(DATA, '', [
      ...
      wbInteger('Flags', itU32, wbFlags(['Playable', 'Guard'], True)).IncludeFlag(dfCollapsed, clpFlags in DefineOptions.Collapse),
      wbInteger('Buys/Sells and Services', itU32, wbServiceFlags(Self)).IncludeFlag(dfCollapsed, clpFlags in DefineOptions.Collapse),
  ...
  wbAIDT :=
    wbStruct(AIDT, 'AI Data', [
     ...
     {08} wbInteger('Buys/Sells and Services', itU32, wbServiceFlags(Self)).IncludeFlag(dfCollapsed, clpFlags in DefineOptions.Collapse),
  ...
  RegisterRecordDef(CREA, 'Creature',
    ...
    wbObjectBounds(Self),
    wbFULLActor,
    wbGenericModel(Self, False, wbActorTemplateUseModelAnimation),
    wbSPLOs,
    ...
    wbModelInfos(Self, NIFT, 'Model List Textures', wbActorTemplateUseModelAnimation),
    ...
    {00} wbInteger('Flags', itU32,
      ...
      {22} wbInteger('Template Flags', itU16, wbTemplateFlags(Self)).IncludeFlag(dfCollapsed, clpFlags in DefineOptions.Collapse)
    ], cpNormal, True),
    wbRArrayS('Factions', wbFaction(Self)).SetDontShow(wbActorTemplateUseFactions),
  ...
  RegisterRecordDef(EFSH, 'Effect Shader', [
    ...
    wbStruct(DATA, '', [
      ...
      wbByteColors(Self, 'Fill/Texture Effect - Color'),
  ...
  RegisterRecordDef(ENCH, 'Object Effect', [
    wbEDIDReq,
    wbFULL,
    wbStruct(ENIT, 'Effect Data', [
      wbInteger('Type', itU32, wbEnum([
  ...
  RegisterRecordDef(MICN, 'Menu Icon', [
    wbEDIDReq,
    wbICONReq
  ]);
  ...
  RegisterRecordDef(PWAT, 'Placeable Water', [
    wbEDIDReq,
    wbObjectBounds(Self),
    wbGenericModel(Self, True),
    wbStruct(DNAM, '', [
  ...
  RegisterRecordDef(NAVI, 'Navmesh Info Map', [
      ...
      wbStructSK(NVMI, [1], 'Navmesh Info', [
        wbInteger('Flags', itU32,
          wbFlags(wbSparseFlags([
            ...
            5, 'Is Island'
          ], False, 6))).IncludeFlag(dfCollapsed, clpFlags in DefineOptions.Collapse),
    ...
    wbRArrayS('Navmesh Connections',
      wbStructSK(NVCI, [0], 'Connection', [
        ...
        wbArrayS('Standard', wbFormIDCk('Navmesh', [NAVM]), -1).IncludeFlag(dfCollapsed, clpNavmesh in DefineOptions.Collapse),
        wbArrayS('Preferred', wbFormIDCk('Navmesh', [NAVM]), -1).IncludeFlag(dfCollapsed, clpNavmesh in DefineOptions.Collapse),
        wbArrayS('Door Links', wbFormIDCk('Door', [REFR]), -1).IncludeFlag(dfCollapsed, clpNavmesh in DefineOptions.Collapse)
      ]).IncludeFlag(dfCollapsed, clpNavmesh in DefineOptions.Collapse)
    ).IncludeFlag(dfCollapsed, clpNavmesh in DefineOptions.Collapse)
  ]);
  ...
  RegisterRefRecordDef(PGRE, 'Placed Grenade',
    wbFlags(wbFlagsList([
      10, 'Persistent',
      11, 'Initially Disabled'
    ])), [
  ...
  RegisterRefRecordDef(PMIS, 'Placed Missile', [
    wbEDID,
    wbFormIDCk(NAME, 'Base', [PROJ], False, cpNormal, True),
    wbFormIDCk(XEZN, 'Encounter Zone', [ECZN]),
  ...
  RegisterRefRecordDef(PBEA, 'Placed Beam', [
    wbEDID,
    wbFormIDCk(NAME, 'Base', [PROJ], False, cpNormal, True),
    wbFormIDCk(XEZN, 'Encounter Zone', [ECZN]),
  ...
  RegisterRecordDef(IMAD, 'Image Space Adapter', [
    ...
    wbRStruct('HDR', [
      ...
      wbTimeInterpolatorsMultAdd(Self, _01_IAD, _41_IAD, 'Blur Radius'),
      wbTimeInterpolatorsMultAdd(Self, _02_IAD, _42_IAD, 'Skin Dimmer'),
      wbTimeInterpolatorsMultAdd(Self, _03_IAD, _43_IAD, 'Emissive Mult'),
      wbTimeInterpolatorsMultAdd(Self, _04_IAD, _44_IAD, 'Target LUM'),
      wbTimeInterpolatorsMultAdd(Self, _05_IAD, _45_IAD, 'Upper LUM Clamp'),
      wbTimeInterpolatorsMultAdd(Self, _06_IAD, _46_IAD, 'Bright Scale'),
      wbTimeInterpolatorsMultAdd(Self, _07_IAD, _47_IAD, 'Bright Clamp'),
      wbTimeInterpolatorsMultAdd(Self, _08_IAD, _48_IAD, 'LUM Ramp No Tex'),
      wbTimeInterpolatorsMultAdd(Self, _09_IAD, _49_IAD, 'LUM Ramp Min'),
      wbTimeInterpolatorsMultAdd(Self, _0A_IAD, _4A_IAD, 'LUM Ramp Max'),
      wbTimeInterpolatorsMultAdd(Self, _0B_IAD, _4B_IAD, 'Sunlight Dimmer'),
      wbTimeInterpolatorsMultAdd(Self, _0C_IAD, _4C_IAD, 'Grass Dimmer'),
      wbTimeInterpolatorsMultAdd(Self, _0D_IAD, _4D_IAD, 'Tree Dimmer')
    ]).SetRequired,
    wbRStruct('Bloom', [
      wbTimeInterpolatorsMultAdd(Self, _0E_IAD, _4E_IAD, 'Blur Radius'),
      wbTimeInterpolatorsMultAdd(Self, _0F_IAD, _4F_IAD, 'Alpha Mult Interior'),
      wbTimeInterpolatorsMultAdd(Self, _10_IAD, _50_IAD, 'Alpha Mult Exterior')
    ]).SetRequired,
    wbRStruct('Cinematic', [
      wbTimeInterpolatorsMultAdd(Self, _11_IAD, _51_IAD, 'Saturation'),
      wbTimeInterpolatorsMultAdd(Self, _12_IAD, _52_IAD, 'Contrast'),
      wbTimeInterpolatorsMultAdd(Self, _13_IAD, _53_IAD, 'Contrast Avg Lum'),
      wbTimeInterpolatorsMultAdd(Self, _14_IAD, _54_IAD, 'Brightness')
    ]).SetRequired,
  ...
  RegisterRecordDef(AVIF, 'ActorValue Information', [
    wbEDIDReq,
    wbFULL,
    wbDESCReq,
    wbICON,
  ...
  RegisterRecordDef(RADS, 'Radiation Stage', [
    wbEDIDReq,
    wbStruct(DATA, '', [
  ...
  RegisterRecordDef(IPDS, 'Impact DataSet', [
    wbEDIDReq,
  ...
  RegisterRecordDef(INGR, 'Ingredient', [
    ...
    wbStruct(ENIT, 'Effect Data', [
      wbInteger('Value', itS32),
      wbInteger('Flags', itU8, wbFlags(['No auto-calculation', 'Food item'])).IncludeFlag(dfCollapsed, clpFlags in DefineOptions.Collapse),
      wbUnused(3)
    ], cpNormal, True),
    wbEffectsReq
  ]);
  ...
  RegisterRecordDef(LVLC, 'Leveled Creature', [
    ...
    wbRArrayS('Leveled List Entries',
      wbRStructExSK([0], [1], 'Leveled List Entry', [
        wbLeveledListEntry(Self, 'Creature', [CREA, LVLC]),
        wbCOED
  ...
  RegisterRecordDef(LVLN, 'Leveled NPC', [
   ...
   RegisterRecordDef(LVLI, 'Leveled Item', [
    ...
    wbRArrayS('Leveled List Entries',
      wbRStructExSK([0], [1], 'Leveled List Entry', [
        wbLeveledListEntry(Self, 'Item', [ALCH, AMMO, ARMO, BOOK, CCRD, CHIP, CMNY, IMOD, KEYM, LVLI, MISC, NOTE, WEAP]),
        wbCOED
      ]).SetSummaryMemberMaxDepth(0, 1)
        .IncludeFlag(dfCollapsed, clpLeveledItems in DefineOptions.Collapse)
    )
  ...
  RegisterRecordDef(MGEF, 'Base Effect', [
    wbEDIDReq,
    wbFULL,
    wbDESCReq,
    wbICON,
    ...
    {0}  wbInteger('Flags', itU32,
           ...
           28, 'No Death Dispel',
           29, '????'
           ], False, 30))).IncludeFlag(dfCollapsed, clpFlags in DefineOptions.Collapse),
    ...
    {17} wbInteger('Archetype', itU32, wbArchtypeEnum(Self)),
    {18} wbActorValue
  ...
  RegisterRecordDef(NPC_, 'Non-Player Character',
    ...
    wbByteColors(Self, HCLR, 'Hair color')
      .SetDontShow(wbActorTemplateUseModelAnimation)
      .SetRequired,
    wbFormIDCk(ZNAM, 'Combat Style', [CSTY]).SetDontShow(wbActorTemplateUseTraits),
    wbInteger(NAM4, 'Impact Material Type', itU32, wbActorImpactMaterialEnum)
      .SetDontShow(wbActorTemplateUseModelAnimation)
      .SetRequired,
    wbFaceGen(Self).SetDontShow(wbActorTemplateUseModelAnimation),
...
//          '',
      ...
      wbUnion('Type Specific Flags', wbPKDTSpecificFlagsDecider, [
        ...
        wbInteger('Type Specific Flags - Find', itU16,
          wbFlags(wbSparseFlags([
            ...
            9, 'Allow Killing',
           10, 'Allow Stealing'
        ], False, 11), True)).IncludeFlag(dfCollapsed, clpFlags in DefineOptions.Collapse),
        wbInteger('Type Specific Flags - Follow', itU16, wbFlags([], True)).IncludeFlag(dfCollapsed, clpFlags in DefineOptions.Collapse),
        ...
        wbInteger('Type Specific Flags - Sleep', itU16, wbFlags([], True)).IncludeFlag(dfCollapsed, clpFlags in DefineOptions.Collapse),
        wbInteger('Type Specific Flags - Wander', itU16,
          wbFlags(wbSparseFlags([
            ...
            4, 'No Furniture',
            5, 'No Wandering'
        ], False, 6), True)).IncludeFlag(dfCollapsed, clpFlags in DefineOptions.Collapse),
        wbInteger('Type Specific Flags - Travel', itU16, wbFlags([], True)).IncludeFlag(dfCollapsed, clpFlags in DefineOptions.Collapse),
        wbInteger('Type Specific Flags - Accompany', itU16, wbFlags([], True)).IncludeFlag(dfCollapsed, clpFlags in DefineOptions.Collapse),
        ...
        ], False, 1), True)).IncludeFlag(dfCollapsed, clpFlags in DefineOptions.Collapse),
        wbInteger('Type Specific Flags - Flee Not Combat', itU16, wbFlags([], True)).IncludeFlag(dfCollapsed, clpFlags in DefineOptions.Collapse),
        wbInteger('Type Specific Flags - Cast Magic', itU16, wbFlags([], True)).IncludeFlag(dfCollapsed, clpFlags in DefineOptions.Collapse),
        ...
        wbInteger('Type Specific Flags - Patrol', itU16, wbFlags([], True)).IncludeFlag(dfCollapsed, clpFlags in DefineOptions.Collapse),
        wbInteger('Type Specific Flags - Guard', itU16,
          wbFlags(wbSparseFlags([
            3, 'Remain Near Reference to Guard'
        ], False, 3), True)).IncludeFlag(dfCollapsed, clpFlags in DefineOptions.Collapse),
        wbInteger('Type Specific Flags - Dialogue', itU16, wbFlags([], True)).IncludeFlag(dfCollapsed, clpFlags in DefineOptions.Collapse),
        wbInteger('Type Specific Flags - Use Weapon', itU16, wbFlags([], True)).IncludeFlag(dfCollapsed, clpFlags in DefineOptions.Collapse)
      ]),
      wbUnused(2)
    ]).SetOptionalFrom(2)
      .SetRequired,
  ...
  var wbHeadParts :=
    wbRArrayS('Parts', wbHeadPart(Self, wbHeadPartIndexEnum, wbGenericModel(Self, True), wbHeadPartsAfterSet), cpNormal, True);

  var wbBodyParts :=
    wbRArrayS('Parts',
      wbRStructSK([0], 'Part', [
        wbInteger(INDX, 'Index', itU32, wbBodyPartIndexEnum(Self)),
        wbICON,
        wbGenericModel(Self, True)
      ])
      .SetSummaryKey([0, 2])
  ...
  RegisterRecordDef(RACE, 'Race', [
    ...
    wbStruct(DATA, '', [
      ...
      .IncludeFlag(dfSummaryNoSortKey)
      .IncludeFlag(dfSummaryMembersNoName)
      .IncludeFlag(dfCollapsed, clpObjectProperties in DefineOptions.Collapse), 7),
      wbUnused(2),
      wbFloat('Male Height'),
  ...
  RegisterRefRecordDef(REFR, 'Placed Object',
    ...
    wbRStruct('Audio Data', [
      ...
      wbInteger(BNAM, 'Flags', itU32, wbFlags(['Use Controller Values'])).IncludeFlag(dfCollapsed, clpFlags in DefineOptions.Collapse),
    ...
    wbSizePosRot(Self, XPTL, 'Portal Data'),
  ...
  RegisterRecordDef(SPEL, 'Actor Effect', [
    wbEDIDReq,
    wbFULL,
    wbStruct(SPIT, '', [
      wbInteger('Type', itU32, wbEnum([
  ...
  RegisterRecordDef(IMOD, 'Item Mod', [
    wbEDIDReq,
    wbObjectBounds(Self),
    wbFULL,
    wbGenericModel(Self),
  ...
  RegisterRecordDef(ALOC, 'Media Location Controller', [
    wbEDIDReq,
    wbFULL,
  ...
  RegisterRecordDef(MSET, 'Media Set', [
    wbEDIDReq,
    wbFULL,
  ...
  RegisterRecordDef(AMEF, 'Ammo Effect', [
    wbEDIDReq,
    wbFULL,
    wbStruct(DATA, 'Data', [
      wbInteger('Type', itU32, wbEnum([
  ...
  RegisterRecordDef(CCRD, 'Caravan Card', [
    wbEDIDReq,
    wbObjectBounds(Self),
    wbFULL,
    wbGenericModel(Self),
  ...
  RegisterRecordDef(CDCK, 'Caravan Deck', [
    wbEDIDReq,
    wbFULL,
    wbRArrayS('Cards',
  ...
  RegisterRecordDef(CHIP, 'Casino Chip', [
    wbEDIDReq,
    wbObjectBounds(Self),
    wbFULL,
    wbGenericModel(Self),
  ...
  RegisterRecordDef(CMNY, 'Caravan Money', [
    wbEDIDReq,
    wbObjectBounds(Self),
    wbFULL,
    wbGenericModel(Self),
  ...
  RegisterRecordDef(DEHY, 'Dehydration Stage', [
    wbEDIDReq,
    wbStruct(DATA, '', [
      wbInteger('Trigger Threshold', itU32),
      wbFormIDCk('Actor Effect', [SPEL])
  ...
  RegisterRecordDef(HUNG, 'Hunger Stage', [
    wbEDIDReq,
    wbStruct(DATA, '', [
      wbInteger('Trigger Threshold', itU32),
      wbFormIDCk('Actor Effect', [SPEL])
  ...
  RegisterRecordDef(LSCT, 'Load Screen Type', [
    wbEDIDReq,
    wbStruct(DATA, 'Data', [
      wbInteger('Type', itU32, wbEnum([
        'None',
  ...
  RegisterRecordDef(RCCT, 'Recipe Category', [
    wbEDIDReq,
    wbFULL,
  ...
  RegisterRecordDef(REPU, 'Reputation', [
    wbEDIDReq,
    wbFULL,
    wbICON,
    wbFloat(DATA, 'Value')
  ...
  RegisterRecordDef(SLPD, 'Sleep Deprivation Stage', [
    wbEDIDReq,
    wbStruct(DATA, '', [
      wbInteger('Trigger Threshold', itU32),
      wbFormIDCk('Actor Effect', [SPEL])
  ...
  RegisterRecordDef(WEAP, 'Weapon',
    ...
    wbYNAM,
    wbZNAM,
    wbTexturedModel(Self, 'Shell Casing Model', [MOD2, MO2T], [wbMO2S, nil]),
    wbTexturedModel(Self, 'Scope Model', [MOD3, MO3T], [wbMO3S, nil]),
