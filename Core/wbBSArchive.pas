...
const
  ...
  HEADER_VERSION_FO4NG = $07; // FO4NG
  HEADER_VERSION_FO4NG2 = $08; // FO4NG2
  ...
  for i := 0 to Pred(fPackedDataCount) do
    if (aSize = fPackedData[i].Size) and CompareMem(@aHash, @fPackedData[i].Hash, SizeOf(aHash)) then begin
      case fType of
        ...
        baFO4, baSF, baFO4NG, baFO4NG2: begin
...
begin
  ...
  if fType <> baTES3 then begin
    ...
    case fVersion of
      ...
      HEADER_VERSION_FO4NG : fType := baFO4NG;
      HEADER_VERSION_FO4NG2 : fType := baFO4NG2;
    else
...
begin
  ...
  if fType in [baTES3] then begin
    ...
    if fType in [baFO4, baSF, baFO4NG, baFO4NG2] then
...
begin
  ...
  try
    ...
    case fType of
      ...
      baFO4, baSF, baFO4NG, baFO4NG2: with PwbBSFileFO4(aFileRecord)^ do begin
        Offset := Position;
        Size := DataSize;
        if aCompress then
          PackedSize := aSize;
