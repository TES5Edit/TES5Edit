...
function TwbGameDefFO3.wbGenericModel(aRequired: Boolean = False; aDontShow: TwbDontShowCallback = nil): IwbRecordMemberDef;
begin
  Result :=
    wbRStructSK([0], 'Model', [
...
initialization
  wbRegisterGameDef([gmFO3], TwbGameDefFO3);
end.
