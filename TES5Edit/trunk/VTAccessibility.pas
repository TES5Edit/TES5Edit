    ...
    if FVirtualTree <> nil then
      ...
      begin
        ...
        begin
          ...
          pszDescription := sTemp2 + FVirtualTree.Text[FVirtualTree.FocusedNode, FVirtualTree.Header.MainColumn{>>>}, False{<<<}]
           +'; ';
        end;
        for I := 0 to FVirtualTree.Header.Columns.Count - 1 do
          ...
          begin
            ...
            sTemp := sTemp + FVirtualTree.Text[FVirtualTree.FocusedNode, I{>>>}, False{<<<}];
            if sTemp <> '' then
