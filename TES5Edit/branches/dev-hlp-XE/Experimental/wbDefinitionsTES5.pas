...
begin
  ...
  Container := aElement.Container;
//  WriteLN('         ->>'+aElement.Name+'       ['+Container.Name+':'+Container.Path+']');
  while Assigned(Container) and (Container.ElementType <> etSubRecord) do
    Container := Container.Container;
...
begin
  ...
  Container := GetContainerFromUnion(aElement);
//  indentS := indentS+'   ';
//  if not Assigned(Container) then WriteLN(indentS+'>>>'+aElement.Name+'       [:]');
//  if not Assigned(Container) then Delete(indentS, Length(indentS)-2, 3);
  if not Assigned(Container) then Exit;
//  WriteLN(indentS+'   '+aElement.Name+'       ['+Container.Name+':'+Container.Path+']');
...
//  WriteLN(indentS+'<<<'+aElement.Name+'       ['+Container.Name+':'+Container.Path+'] = '+IntToStr(Result));
