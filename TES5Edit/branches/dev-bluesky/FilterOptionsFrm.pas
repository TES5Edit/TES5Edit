...
begin
  ...
  clbConflictAll.Items.Add('独立的记录');
  clbConflictAll.Items.Add('多种数值但是没有冲突');
  clbConflictAll.Items.Add('良性冲突');
  clbConflictAll.Items.Add('覆盖但没有冲突');
  clbConflictAll.Items.Add('冲突');
  clbConflictAll.Items.Add('严重冲突');

  clbConflictThis.Items.Add('未定义');
  clbConflictThis.Items.Add('ITM 记录');
  clbConflictThis.Items.Add('独立的记录');
  clbConflictThis.Items.Add('Mod 群组隐藏的记录');
  clbConflictThis.Items.Add('Master');
  clbConflictThis.Items.Add('良性冲突');
  clbConflictThis.Items.Add('覆盖但没有冲突');
  clbConflictThis.Items.Add('ITM 记录但是是冲突的赢方');
  clbConflictThis.Items.Add('冲突赢方');
  clbConflictThis.Items.Add('冲突败方');
