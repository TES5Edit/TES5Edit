...
- [TES5] BODT/BOD2 and different VMAD ## objects are now lined up for conflict resolution
...
## 3.0.28
- With this ## it is important to clean all of your plugins after restoring the original Nexus or Steam workshop files. (Don't ask about this in the forum)
...
## 3.0.19 
- contains improves record definitions to handle DeadMoney.esm better
...
## 3.0.13 
- syncs up the engine with the most current ## of TES4Edit, TES4LODGen and FNVEdit.
